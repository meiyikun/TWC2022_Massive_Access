...
% clc; clear;
tic
addpath('E:\myk\massive access\twc_massive_access_open\');
warning off

%% System Parameters
K = 500;     % the number of potential devices
Ka = 50;     % the number of active devices  
T = 7;      % the number of consecutive OFDM symbols
...
Nsim = 5000;                  % the number of simulation
SNR_dB = [0:2:12];              
...
gcf_set = [p1,p5,p7,p9,p10,p11,p12,p13];
legend(gcf_set,{'AMP-MMV','OAMP-MMV-SSL','OAMP-MMV-ASL','SWOMP','GSP','SAMP','Oracle LS','Gene-aided OAMP'},'location','southwest','interpreter','latex');
